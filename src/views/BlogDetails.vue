...
import { getBlogBySlug, type BlogPostType } from '@/services/blogService'

const route = useRoute()
const post = ref<BlogPostType | null>(null)

onMounted(() => {
  const result = getBlogBySlug(route.params.slug as string)
  post.value = result !== undefined ? result : null
})
</script>
